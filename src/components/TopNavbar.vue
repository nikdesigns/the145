                ...
                <TabList class="-mb-px flex px-4 space-x-8">
                  ...
                  >
                    <button
                      :class="[
                        selected
                          ? 'text-brand-navy-300 border-brand-navy-300'
        ...
        <div class="bg-brand-navy-500">
          ...
          >
                ...
                >
                  <select
                    ...
                    class="
                      ...
                      group-hover:text-brand-navy-100
            ...
            <p
              ...
              "
            >
              Nominations are now open for Top Shop 2022
            </p>
            ...
            >
              <a
                ...
                class="
                  ...
                  font-medium
                  text-brand-white-100
                  hover:text-brand-navy-100
                "
                >Create an account</a
              >
              <span class="h-6 w-px bg-brand-white-100" aria-hidden="true" />
              <a
                @click="showLoginModal"
                href="#"
                class="
            ...
            <div class="border-b border-gray-200">
              <div class="h-16 flex items-center justify-between">
                ...
                <div class="hidden lg:flex lg:items-center">
                  <a href="/">
                    <span class="sr-only">The145</span>
                    <img
                      class="h-9 w-auto"
                      ...
                      >
                        <div class="relative flex">
                          <PopoverButton
                            :class="[
                              open
                                ? 'border-brand-navy-300 text-brand-navy-300'
                                : 'border-transparent text-gray-700 hover:text-gray-800',
                              'relative z-10 flex items-center transition-colors ease-out duration-200 text-sm font-medium border-b-2 -mb-px pt-px',
                            ]"
                          >
                            {{ category.name }}
                            <ChevronDownIcon class="h-4 pl-1" />
                          </PopoverButton>
                        </div>
  ...
  categories: [
    {
      ...
      featured: [
        { name: "Search", href: "#" },
        { name: "Mega Search", href: "#" },
        { name: "RFQ", href: "#" },
        { name: "Part Xperts", href: "#" },
      ],
      collection: [
      ...
      categories: [
        { name: "Who Searched", href: "#" },
        { name: "Your Top 100", href: "#" },
